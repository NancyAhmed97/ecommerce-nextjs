                                    ...
                                    <div className="login_wrap widget-taber-content background-white">
                                        <div className="padding_eight_all bg-white">
                                            <div className="heading_s1">
                                                ...
                                                <p className="mb-30">Already have an account? <Link href="/page-login"><a>Log in</a></Link></p>
                                            </div>
                                            <form method="post">
                                                ...
                                                <div className="form-group">
                                                    <button type="submit" className="btn btn-heading btn-block hover-up" name="login">Create</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
